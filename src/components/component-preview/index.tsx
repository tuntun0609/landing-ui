...
export function ComponentPreviewContent({
  ...
  return (
    <TabsContent className="mt-2 w-full p-0" value="preview" key={key}>
      <div className="relative flex min-h-[350px] w-full flex-col items-center justify-center rounded-lg border border-neutral-200 p-2 dark:border-neutral-800 sm:p-10">
