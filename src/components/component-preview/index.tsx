...
export function ComponentPreviewContent({ name }: { name: string }) {
  ...
  return (
    <TabsContent className="mt-2 w-full p-0" value="preview">
      <div className="relative flex min-h-[350px] w-full items-center justify-center rounded-lg border border-neutral-200 p-2 sm:p-10">
        <div className="absolute inset-0 -z-10 h-full w-full bg-white bg-[linear-gradient(to_right,#8080800a_1px,transparent_1px),linear-gradient(to_bottom,#8080800a_1px,transparent_1px)] bg-[size:10px_10px]" />
